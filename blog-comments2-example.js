var script = document.createElement('script');
    ...
    script.setAttribute('src', 'https://v2mm.tech/plugins/nodebb-plugin-blog-examsbook/lib/simple-typecho.js');
...
var script = document.createElement('script');
    script.setAttribute('type', 'text/javascript');
    script.setAttribute('src', 'http://localhost:4567/plugins/nodebb-plugin-blog-examsbook/lib/simple-typecho.js');
    script.setAttribute('id', 'nodebb-comments-script');
    script.setAttribute('async', 'true');
...
/*
<script id='nodebb-comments-script' async="true", ourl="https://v2mm.tech" ocid="64" blogger='qqqq' src="https://v2mm.tech/plugins/nodebb-plugin-blog-examsbook/lib/simple-typecho.js"></script>
...
代码是开源的，在 https://github.com/revir/nodebb-plugin-blog-examsbook
